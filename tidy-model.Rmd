...
Graph shows the chirp rate of two species of crickets. Red has a higher chirp rate than blue, but both chirp rates increase as temperature increases.
Model shows chirp rate increases with temperature, different species have different base line of chirp rate, shows almost all variations in chirp rate.
UPDATE:  checked for interactions but decided to stay with the species model
...
ggplot(crickets, aes(x = rate, fill = species)) +
  ...
  xlab('Chirp rate (per min.)')
```
Blue has lower chirp rate than red.
